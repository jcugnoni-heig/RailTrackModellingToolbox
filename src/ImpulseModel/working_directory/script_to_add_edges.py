...
([unitCell], status) = smesh.CreateMeshesFromMED(r'/home/cae/Documents/TrackSystemEvaluation/working_directory/unitCell.med')
...
try:
  unitCell.ExportMED(r'/home/cae/Documents/TrackSystemEvaluation/working_directory/unitCellWithClamps.med',auto_groups=0,minor=40,overwrite=1,meshPart=None,autoDimension=1)
  pass
except:
